...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.TaskViewHolder> {
    ...
    private List<EventEntry> mTaskEntries;
    ...
    public TaskViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext)
                .inflate(R.layout.journal_data_layout, parent, false);
    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        EventEntry eventEntry = mTaskEntries.get(position);
        String description = eventEntry.getDescription();
        //int priority = eventEntry.getPriority();
   ...
   /* private int getPriorityColor(int priority) {
     ...
     */
    public void setTasks(List<EventEntry> taskEntries) {
    ...
    //returns the number of items to be viewed
    ...
    public List<EventEntry> getTasks() {
        return mTaskEntries;
    }
}